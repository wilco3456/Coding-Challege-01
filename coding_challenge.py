"""
Please write you name here: Wilson Wobo
"""
import csv
import sys
...
def process_shifts(path_to_csv):
    ...
    # Doesn't allow duplicate times because the dictionary key should be unique
    # Used incrementing digit as the dictionary key instead
